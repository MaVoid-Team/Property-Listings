(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__120d850a._.js",
...
function middleware(request) {
    ...
    // Check if there's a locale cookie preference
    const localeCookie = request.cookies.get('NEXT_LOCALE')?.value;
    // If accessing root without locale, check cookie for preference
    if (pathname === '/') {
        const preferredLocale = localeCookie && __TURBOPACK__imported__module__$5b$project$5d2f$i18n$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["locales"].includes(localeCookie) ? localeCookie : __TURBOPACK__imported__module__$5b$project$5d2f$i18n$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["defaultLocale"];
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL(`/${preferredLocale}`, request.url));
    }
    // Let intl middleware handle everything else
    const response = intlMiddleware(request);
    // Set locale cookie based on current locale in URL
    const pathnameLocale = __TURBOPACK__imported__module__$5b$project$5d2f$i18n$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["locales"].find((locale)=>pathname.startsWith(`/${locale}/`) || pathname === `/${locale}`);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__120d850a._.js.map